...
#[derive(new)]
pub struct Group<I: FallibleIterator<Item = R, Error = E>, R, S, E, G, C, H>
where
    G: Fn(R) -> S,
    C: Fn(&S, &R) -> bool,
    H: Fn(&mut S, R),
...
impl<I: FallibleIterator<Item = R, Error = E>, R, S, E, G, C, H> FallibleIterator
    for Group<I, R, S, E, G, C, H>
where
    G: Fn(R) -> S,
    C: Fn(&S, &R) -> bool,
    H: Fn(&mut S, R),
