...
pub mod tokenize {
    use crate::chain::streams::read_input::Record0 as RecordIn;
    use crate::chain::streams::read_input::Record1 as RecordOut;
    use crate::chain::streams::read_input::UnpackedRecord1 as UnpackedRecordOut;
