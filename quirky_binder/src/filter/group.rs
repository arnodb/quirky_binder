...
pub fn group(
    ...
    let _trace_name = TraceName::push(GROUP_TRACE_NAME);
...
impl SubGroup {
    pub fn new(
        ...
        let (path_streams, group_stream) = streams
            .output_from_input(0, true, graph)
            .with_trace_element(trace_element!())?
            .update()
            .path(
...
pub fn sub_group(
    ...
    let _trace_name = TraceName::push(SUB_GROUP_TRACE_NAME);
